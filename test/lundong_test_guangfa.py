...
def time_truncate(data, start_date_str, end_date_str):
	...
	i = 0
	while i < len(data):
		date = datetime.strptime(data[i][DATE_POS], "%Y-%m-%d")
...
if __name__ == "__main__":
	...
	sz399008_data = load_data("../data/sz399008")
	sh000300_data = load_data("../data/sh000300")

	gf270026_data = load_data("../data/270026")
	gf270010_data = load_data("../data/270010")
	...
	gain_rate, gain_rate_real = test(sz399008_data, sh000300_data, "sz399008", "sh000300", gf270026_data, gf270010_data, "gf270026", "gf270010", 100000, 28, 4)
