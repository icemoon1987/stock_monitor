...
class index_lundong_monitor(object):
    ...
    def format_result(self, result):
        ...
        mail_detail = "四周前日期： " + result["last_date"] + "\n"
    ...
    def format_html_result(self, result):
        mail_detail = "<p>四周前日期： " + result["last_date"] + "</p>\n"
        ...
        mail_detail += "<tr><td>权重</td><td>沪深300</td><td>sh000300</td><td>" + str(result["sh000300"][0]) + "</td><td>" + str(result["sh000300"][1]) + "</td><td><span style=\"color: " + color + ";\">" + str(int(result["sh000300"][2] * 10000) / 100.0 ) + "%" + "</span></td>" + "<td>华泰柏瑞沪深300ETF(510300)、广发沪深300(270010)</td></tr>\n"

        color = "green"
        if result["sh000905"][2] > 0:
            color = "red"

        mail_detail += "<tr><td>中小</td><td>中小盘500</td><td>sh000905</td><td>" + str(result["sh000905"][0]) + "</td><td>" + str(result["sh000905"][1]) + "</td><td><span style=\"color: " + color + ";\">" + str(int(result["sh000905"][2] * 10000) / 100.0 ) + "%" + "</span></td>" + "<td>南方中证500ETF(510500)</td></tr>\n"

        color = "green"
        if result["sz399008"][2] > 0:
            color = "red"

        mail_detail += "<tr><td>中小</td><td>中小板300</td><td>sz399008</td><td>" + str(result["sz399008"][0]) + "</td><td>" + str(result["sz399008"][1]) + "</td><td><span style=\"color: " + color + ";\">" + str(int(result["sz399008"][2] * 10000) / 100.0 ) + "%" + "</span></td>" + "<td>广发中小板300联(270026)</td></tr>\n"
